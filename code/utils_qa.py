...
def postprocess_qa_predictions(
    ...
    for example_index, example in enumerate(tqdm(examples)):
        ...
        for feature_index in feature_indices:
            ...
            # 상위 n_best_size 개의 start_indexes와 end_indexes를 가져옵니다.
            ...
            for start_index in start_indexes:
                for end_index in end_indexes:
                    ...
                    if (start_index >= len(offset_mapping) or end_index >= len(offset_mapping) or offset_mapping[start_index] is None or
        ...
        # 현 대회의 데이터셋에는 정답이 없는 데이터가 없기 때문에 고려하지 않아도 됩니다.
        if version_2_with_negative:
        ...
        else:  # 현재 대회에서는 question에 대한 답이 무조건 있어야 하므로 이 else문은 고려하지 않아도 됩니다.
        ...
        # all_nbest_json: Dict[id: List[Dict[start_logit, end_logit, text, probability]]]
